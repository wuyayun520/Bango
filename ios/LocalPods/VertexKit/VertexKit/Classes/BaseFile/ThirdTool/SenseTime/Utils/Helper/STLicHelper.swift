...
@objcMembers public class STLicHelper: NSObject {
    ...
    func checkLicenseFromLocal() -> Bool {
        if let path = AtPodspecBundle.bundle.path(forResource: "SENSEME", ofType: "lic") {
...
extension STLicHelper {
    ...
    func checkLicFileMd5With(md5: NSString) -> Bool {
        ...
        let fileMd5: NSString = SymbolReactiveCompatible.shared.trademark(filePath: filePath as String) as NSString
