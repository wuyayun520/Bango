...
class STBeautyTopItemView: UIView {
    ...
    private lazy var resetBtn: UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage.collectionName(name: "icon_cz_nor"), for: .normal)
...
extension STBeautyTopItemView {
    ...
    func setupSubviews() {
        ...
        for (i, item) in items.enumerated() {
            ...
            if i == 0 {
                ...
                let startX = TextLanguageManager.shared.direction == .rightToLeft ? (Int(kLet_errData)-6-buttonW/2):6+buttonW/2
        ...
        resetBtn.snp.makeConstraints { make in
            make.leading.equalTo(kLet_errData-10-30)
            make.top.equalTo(10)
    ...
    func setButtonStatus(sender: UIButton) {
        ...
        self.selectButton.titleLabel?.font = UIFont.ofAndSize(type: .Semibold, fontSize: 14)
    ...
    @objc func resetBtnClick() {
        ...
        CurrentThen.leftModel(message: "Restore to default Beautify Settings".localized, leftBtnTitle: "Cancel".localized, rightBtnTitle: "OK".localized, leftBlock: {
            CurrentThen.meeting()
