...
@objcMembers public class STParamUtil: NSObject {
    ...
    func getFilterModelPathsByType(type: STEffectsType) -> Array<Any> {
        ...
        let strBundlePath: String = AtPodspecBundle.bundle.resourcePath?.appending(strPrefix.appending(".bundle")) ?? ""
    ...
    func getTrackerPaths() -> Array<Any> {
        ...
        let strBundlePath: String = AtPodspecBundle.bundle.resourcePath ?? ""
