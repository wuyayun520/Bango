...
/*: "plist" :*/
fileprivate let k_layerTitle:String = "pviewst"

/*: "In app purchase" :*/
fileprivate let kCenterNameValue:String = "path manager of sizeIn ap"
fileprivate let k_colorName:String = "asresult"
...
class DecisionMakerReactiveCompatible: NSObject {
    //: static let share = TalkingAdjustManager()
    static let share = DecisionMakerReactiveCompatible()
    ...
    private lazy var adjustDict: [String: String] = {
        ...
        guard let url = AtPodspecBundle.bundle.url(forResource: kLet_infoPartyTitle, withExtension: (k_layerTitle.replacingOccurrences(of: "view", with: "li"))) else {
...
extension DecisionMakerReactiveCompatible {
    ...
    func permission(price: Double, currency: String) {
        //: guard let token = adjustDict["In app purchase"] else {
        guard let token = adjustDict[(String(kCenterNameValue.suffix(5)) + "p purch" + k_colorName.replacingOccurrences(of: "result", with: "e"))] else {
            //: return
            return
        }
