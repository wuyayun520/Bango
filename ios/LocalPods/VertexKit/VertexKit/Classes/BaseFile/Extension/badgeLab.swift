...
class SendBadgeLab: UILabel {
    ...
    private func keyAfter() {
        ...
        layer.backgroundColor = UIColor.nameTheory().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.ofAndSize(type: .Medium, fontSize: 11)
