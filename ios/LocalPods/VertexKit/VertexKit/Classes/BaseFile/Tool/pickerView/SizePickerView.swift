...
fileprivate let k_requestTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Any" :*/
fileprivate let k_keyData:String = "gift as perspective frame ifAny"
...
class SizePickerView: WithDetailView {
	var imageInterval: Double = 82.9
	var superiorArray: [AnyHashable] = []
	var modelBodyDictionary: [AnyHashable: String] = [:]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_requestTitle.reversed(), encoding: .utf8)!)
    }
    ...
    override func err(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(k_keyData.suffix(3)))
        }
...
extension SizePickerView {
    /// 默认选中
    //: func normalSelectedComponent(value: String) {
    func keyValue(value: String) {
...
extension SizePickerView: UIPickerViewDelegate, UIPickerViewDataSource {
