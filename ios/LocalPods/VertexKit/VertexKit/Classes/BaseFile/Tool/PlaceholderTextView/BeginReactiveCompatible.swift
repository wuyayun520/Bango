...
/*: / :*/
fileprivate let k_tempName:String = "device"

/*: "\n" :*/
fileprivate let k_ofData:String = "\n"
...
class BeginReactiveCompatible: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        firstColor(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        firstColor(placeholder: nil, placeholderColor: nil)
    }
}
...
extension BeginReactiveCompatible {
    ...
    private func firstColor(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(EnvironmentLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(EnvironmentLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-EnvironmentLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: ServiceContainerInset().top, left: ServiceContainerInset().left, bottom: ServiceContainerInset().bottom, right: ServiceContainerInset().right)
...
extension BeginReactiveCompatible: UITextViewDelegate {
...
extension BeginReactiveCompatible {
    ...
    private func butterCookieShould() {
