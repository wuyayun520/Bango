...
fileprivate let kOfContent:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c","o","n","t","i","n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let k_labelTotalTitle:[UInt8] = [0xab,0xac,0xab,0xb6,0xea,0xa1,0xad,0xa6,0xa7,0xb0,0xf8,0xeb,0xe2,0xaa,0xa3,0xb1,0xe2,0xac,0xad,0xb6,0xe2,0xa0,0xa7,0xa7,0xac,0xe2,0xab,0xaf,0xb2,0xae,0xa7,0xaf,0xa7,0xac,0xb6,0xa7,0xa6]

private func infoM(price num: UInt8) -> UInt8 {
    return num ^ 194
}
...
class CurrentAlertView: UIView {
	var replyEnable: Bool = false
	var startDictionary: [AnyHashable: String] = [:]
	var skipDoing: Bool = false
	var willDictionary: [AnyHashable: String] = [:]
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(windowDoing), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(bottomClick), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: LibraryAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(kOfContent))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_labelTotalTitle.map{infoM(price: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func yearMedium(title: String, isTouch: Bool) {
