...
fileprivate let kVideoScaleData:[UInt8] = [0x29,0x2e,0x29,0x34,0xe8,0x23,0x2f,0x24,0x25,0x32,0xfa,0xe9,0xe0,0x28,0x21,0x33,0xe0,0x2e,0x2f,0x34,0xe0,0x22,0x25,0x25,0x2e,0xe0,0x29,0x2d,0x30,0x2c,0x25,0x2d,0x25,0x2e,0x34,0x25,0x24]

fileprivate func analogDigitalConverter(fatal num: UInt8) -> UInt8 {
...
let kLet_appFormalValue = 3.0

//: class CircleCountdownView: UIView {
class ArcReactiveCompatible: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.appPath() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kVideoScaleData.map{analogDigitalConverter(fatal: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.ofAndSize(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: kLet_appFormalValue / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: kLet_appFormalValue / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - kLet_appFormalValue,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - kLet_appFormalValue)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.appPath().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kLet_appFormalValue
...
extension ArcReactiveCompatible {
    /// 创建UI
    //: private func createUI() {
    private func distilUi() {
    ...
    func reload(totalTime: Int, currTime: Int) {
