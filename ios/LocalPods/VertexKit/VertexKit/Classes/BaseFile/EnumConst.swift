...
enum MediaItemTermConvertible: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum LengthOutputStream: String {
    //: case AppleLogin
...
enum GiftExpressionConvertible: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum UserConstellationColumnConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum StraddleIntervalLiteral: Int {
    //: case isOnGoing = 0
...
@objc enum SkinSubscriptType: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum DetainExpressionConvertible: Int {
    //: case Unavailable = 0
...
enum MakeCellType: CaseIterable {
