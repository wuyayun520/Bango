...
/*: "detection" :*/
fileprivate let k_toValue:String = "deequale"

/*: "aiff" :*/
fileprivate let kKeyName:String = "apickff"
...
// __CLOSE_PRINT__
//
//  GlobalReactiveCompatible.swift
//  VertexKit
//
...
class GlobalReactiveCompatible: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = GlobalReactiveCompatible()
    ...
    func sinceEach() {
        ...
        let soundFilePath = DataEnvironmentReactiveCompatible.default.deciding(name: (k_toValue.replacingOccurrences(of: "equal", with: "t") + "ction"), type: (kKeyName.replacingOccurrences(of: "pick", with: "i")))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            GlobalReactiveCompatible.shared.sectionComplete()
        }
    ...
    @objc private func blockPush() {
        //: soundDuration += 0.001
        soundDuration += 0.001
    }

    //: func playbackComplete() {
    func sectionComplete() {
