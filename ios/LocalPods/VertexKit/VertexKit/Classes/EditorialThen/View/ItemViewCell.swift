...
fileprivate let kEnableData:[UInt8] = [0x15,0x12,0x15,0x8,0x54,0x1f,0x13,0x18,0x19,0xe,0x46,0x55,0x5c,0x14,0x1d,0xf,0x5c,0x12,0x13,0x8,0x5c,0x1e,0x19,0x19,0x12,0x5c,0x15,0x11,0xc,0x10,0x19,0x11,0x19,0x12,0x8,0x19,0x18]

private func tableImage(design num: UInt8) -> UInt8 {
    return num ^ 124
}

/*: "Add" :*/
fileprivate let k_sizeToEqualData:[Character] = ["A","d","d"]

/*: "btn_me_edit" :*/
fileprivate let k_methodName:String = "else if name momentbtn_me_e"
fileprivate let kManagerData:[Character] = ["d","i","t"]

/*: "Program" :*/
fileprivate let k_textValue:String = "Progrin share table else"
fileprivate let k_mainTitle:String = "acolor"
...
class ItemViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kEnableData.map{tableImage(design: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(fileLocation), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(k_sizeToEqualData)).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.collectionName(name: (String(k_methodName.suffix(8)) + String(kManagerData))))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension ItemViewCell {
    ...
    func package(title: String, icon: String) {
        //: iconImg.image = UIImage.collectionName(name: icon)
        iconImg.image = UIImage.collectionName(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(k_textValue.prefix(5)) + k_mainTitle.replacingOccurrences(of: "color", with: "m")) {
    ...
    func turnArrow() {
        ...
        backBtn.quantityryAcross(width: kLet_errData - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
