...
/*: "id" :*/
fileprivate let kCurrentTitle:String = "imove"
...
struct EnvironmentHandyJSON: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: UserTimeModelType?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [SelectedHandyJSON]? // 相册
    ...
    var aiExtraInfo = PublishAppHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct UserTimeModelType: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [RefreshRoundModelType]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct RefreshRoundModelType: HandyJSON {
...
struct SelectedHandyJSON: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func voiceOf(compareTo: SelectedHandyJSON) -> Bool {
        //: return
        return
...
struct PublishAppHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
