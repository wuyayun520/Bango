...
fileprivate let kLoadAgeData:[UInt8] = [0x53,0x54,0x53,0x4e,0x12,0x59,0x55,0x5e,0x5f,0x48,0x0,0x13,0x1a,0x52,0x5b,0x49,0x1a,0x54,0x55,0x4e,0x1a,0x58,0x5f,0x5f,0x54,0x1a,0x53,0x57,0x4a,0x56,0x5f,0x57,0x5f,0x54,0x4e,0x5f,0x5e]

private func contentTable(content num: UInt8) -> UInt8 {
    return num ^ 58
}

/*: "JXBannerCellID" :*/
fileprivate let kVoiceName:[Character] = ["J","X","B"]
fileprivate let k_replyText:String = "atexter"
...
class WithView: UITableViewCell {
	var viewEndOn: Bool = true
	var aboutTitle: String = "index"

    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [EventMeasurable]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kLoadAgeData.map{contentTable(content: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var bannerView: JXBanner = {
        ...
        banner.placeholderImgView.image = UIImage.even()
...
extension WithView: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(kVoiceName) + k_replyText.replacingOccurrences(of: "text", with: "nn") + "CellID"))
    }
    ...
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        ...
        if index < self.adBannderListData.count {
            ...
            tempCell.imageView.stopDown(urlStr: model.pic, placeImg: UIImage.even())
...
extension WithView {
    ...
    func nameStart(bannerData: [EventMeasurable]) {
...
extension WithView {
    ...
    private func numbererruptToSubviews() {
