...
fileprivate let kCameraTitle:[UInt8] = [0x73,0x78,0x73,0x7e,0x32,0x6d,0x79,0x6e,0x6f,0x7c,0x44,0x33,0x2a,0x72,0x6b,0x7d,0x2a,0x78,0x79,0x7e,0x2a,0x6c,0x6f,0x6f,0x78,0x2a,0x73,0x77,0x7a,0x76,0x6f,0x77,0x6f,0x78,0x7e,0x6f,0x6e]

fileprivate func heightWith(equal num: UInt8) -> UInt8 {
...
/*: "gift_bg_dm" :*/
fileprivate let k_giftData:String = "gift_end max for view"
fileprivate let k_followTitle:[Character] = ["b","g","_","d","m"]

/*: "#FFF4B5" :*/
fileprivate let k_labelValue:String = "#FFF4B5add if"

/*: "won " :*/
fileprivate let kCancelValue:[Character] = ["w","o","n"," "]

/*: " coins in " :*/
fileprivate let k_modelStarGiftData:String = " coins ifalse cell make"
fileprivate let kTextContentData:String = "n share else error"

/*: " x :*/
fileprivate let k_birthdayValue:String = " xdirection actual color"

/*: "just sent" :*/
fileprivate let kEdgeData:[Character] = ["j","u","s","t"," ","s","e","n","t"]

/*: "  :*/
fileprivate let kTextClearErrName:String = "to"

/*: "#4120C1" :*/
fileprivate let k_collectionContent:String = "#4120C1height for request album length"
...
class EconomicAidFloatView: UIView {
    /// 礼物model
    //: private var giftModel = SocialBroadcastModel()
    private var giftModel = RowModelType()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kCameraTitle.map{heightWith(equal: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var bgView: UIImageView = {
        //: let v = UIImageView()
        let v = UIImageView()
        //: v.image = UIImage.collectionName(name: "gift_bg_dm")
        v.image = UIImage.collectionName(name: (String(k_giftData.prefix(5)) + String(k_followTitle)))
    ...
    private lazy var icon: UIImageView = {
        ...
        v.layer.borderColor = UIColor(hex: (String(k_labelValue.prefix(7))))?.cgColor
    ...
    private lazy var nicknameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(k_labelValue.prefix(7))))
...
extension EconomicAidFloatView {
    /// 刷新视图
    //: func refreshGift(_ model: SocialBroadcastModel) {
    func afterDisappear(_ model: RowModelType) {
        //: giftModel = model
        giftModel = model
        //: icon.setUrlImage(urlStr: giftModel.headPic)
        icon.followOut(urlStr: giftModel.headPic)
        ...
        if giftModel.broadStatus == 1 { // 中奖
            ...
            contentLab.text = (String(kCancelValue)).localized + "\(giftModel.totalCoin)" + (String(k_modelStarGiftData.prefix(8)) + String(kTextContentData.prefix(2))).localized + giftModel.gameName
            ...
            if let range = fullText.range(of: rangeText) {
                ...
                attributedString.addAttribute(.foregroundColor, value: UIColor(hex: (String(k_collectionContent.prefix(7))))!, range: nsRange)
            }
    ...
    private func viewMore(giftmodel: RowModelType) -> String {
...
extension EconomicAidFloatView {
    ...
    private func mapSubviews() {
        ...
        self.frame = CGRect(x: 0, y: kLet_viewName, width: kLet_errData, height: 60)
