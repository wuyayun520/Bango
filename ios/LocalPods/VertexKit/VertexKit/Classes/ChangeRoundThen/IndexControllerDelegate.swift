...
class IndexControllerDelegate: UINavigationController {

    //: var tabBarType: TabBarItemType?
    var tabBarType: MediaItemTermConvertible?
    //: var pushing = false                             
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        if viewControllers.count >= 1 {
            ...
            if viewController.navigationItem.leftBarButtonItem == nil {
                ...
                viewController.navigationItem.leftBarButtonItem = viewController.equalSendItem()
            }
        }
    ...
    func bringAppearance() {
        ...
        if #available(iOS 15.0, *) {
            ...
            barApp.backgroundImage = UIImage.visualPropertyAdd(color: UIColor.white)
            //: barApp.shadowImage = UIImage.init()
            barApp.shadowImage = UIImage.init()
            //: barApp.shadowColor = UIColor.appBgColor()
            barApp.shadowColor = UIColor.textTag()
            ...
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.dropMultiView(), NSAttributedString.Key.font: UIFont.ofAndSize(type: .Medium, fontSize: 17)]
        ...
        //: } else {
            ...
            navigationBar.setBackgroundImage(UIImage.visualPropertyAdd(color: UIColor.white), for: .any, barMetrics: .default)
            ...
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.dropMultiView(), NSAttributedString.Key.font: UIFont.ofAndSize(type: .Medium, fontSize: 17)]
        }
        //: UINavigationBar.appearance().tintColor = UIColor.appTitleColor()
        UINavigationBar.appearance().tintColor = UIColor.dropMultiView()
...
extension IndexControllerDelegate: UINavigationControllerDelegate {
...
extension IndexControllerDelegate: UIGestureRecognizerDelegate {
