...
/*: "#777777" :*/
fileprivate let k_kitValue:String = "#777777"

/*: "#333333" :*/
fileprivate let kStartData:[Character] = ["#","3","3","3","3","3","3"]

/*: "Followers" :*/
fileprivate let kViewTextValue:[Character] = ["F","o","l","l","o"]
fileprivate let kHiddenData:String = "wsystems"

/*: "Following" :*/
fileprivate let k_playContent:String = "screen"
fileprivate let kDraftData:String = "ollowstatusg"

/*: "nav_back_black_nor" :*/
fileprivate let kOfImageContent:String = "nav_bof open regular title"
fileprivate let kUserName:String = "result table head netack_blac"
fileprivate let k_modelText:String = "height make image draftk_nor"
...
class LengthViewDelegate: RecordReactiveCompatible {
	var cornerDoing: Bool = false
	var totalGiftCount: Double = 39.3
...
//        segmentedDataSource.itemSpacing = 0
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (k_kitValue.capitalized))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (String(kStartData)))!
        ...
        indicator.indicatorColor = UIColor(hex: (String(kStartData)))!
    ...
    private lazy var titleArray: [String] = //: return ["Followers".localized, "Following".localized]
        [(String(kViewTextValue) + kHiddenData.replacingOccurrences(of: "system", with: "er")).localized, (k_playContent.replacingOccurrences(of: "screen", with: "F") + kDraftData.replacingOccurrences(of: "status", with: "in")).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [RecordReactiveCompatible] = //: return [PopViewController(), RowDataSource()]
        [PopViewController(), RowDataSource()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.collectionName(name: (String(kOfImageContent.prefix(5)) + String(kUserName.suffix(8)) + String(k_modelText.suffix(5)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(queryClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LengthViewDelegate: JXSegmentedViewDelegate {
...
extension LengthViewDelegate: JXPagingViewDelegate {
...
extension LengthViewDelegate {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func queryClick() {
