...
fileprivate let kPathData:[UInt8] = [0xd1,0xd6,0xd1,0xcc,0x90,0xdb,0xd7,0xdc,0xdd,0xca,0x82,0x91,0x98,0xd0,0xd9,0xcb,0x98,0xd6,0xd7,0xcc,0x98,0xda,0xdd,0xdd,0xd6,0x98,0xd1,0xd5,0xc8,0xd4,0xdd,0xd5,0xdd,0xd6,0xcc,0xdd,0xdc]

private func giftBackground(priority num: UInt8) -> UInt8 {
    return num ^ 184
}

/*: "icon_home_boy" :*/
fileprivate let kLabFromValue:[Character] = ["i","c","o","n","_","h","o","m","e","_","b","o"]
fileprivate let kAlongColorData:String = "index"

/*: "icon_home_girl" :*/
fileprivate let k_removeData:String = "icon_hview click model"

/*: "   " :*/
fileprivate let kSexData:[Character] = [" "," "," "]
...
class DoingLineViewCell: UITableViewCell {
	var clickQuantity: Int = 70
	var tossText: String = "show"
	var acrossSum: Int = 34
	var videoContent: String = "view"
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kPathData.map{giftBackground(priority: $0)}, encoding: .utf8)!)
    }
...
extension DoingLineViewCell {
    ...
    func sizeType(model: DetailReactiveCompatible, type: ColorColumnConvertible) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.collectionName(name: (String(kLabFromValue) + kAlongColorData.replacingOccurrences(of: "index", with: "y"))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.collectionName(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.collectionName(name: (String(k_removeData.prefix(6)) + "ome_girl")), for: .normal)
        //: break
        //: default:
        default:
            //: break
