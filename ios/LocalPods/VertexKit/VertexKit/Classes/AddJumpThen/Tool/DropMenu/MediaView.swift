...
fileprivate let kCellData:[UInt8] = [0x3b,0x40,0x3b,0x46,0xfa,0x35,0x41,0x36,0x37,0x44,0xc,0xfb,0xf2,0x3a,0x33,0x45,0xf2,0x40,0x41,0x46,0xf2,0x34,0x37,0x37,0x40,0xf2,0x3b,0x3f,0x42,0x3e,0x37,0x3f,0x37,0x40,0x46,0x37,0x36]

fileprivate func styleLoad(name num: UInt8) -> UInt8 {
...
class MediaView: UITableViewCell {
	var blockTotal: Int = 20
	var rowName: String = "background"
	var cutDictionary: [AnyHashable: String] = [:]
	var commentDeleteSum: Int = 4
	var nameTitle: String = "greet"
	var indexDictionary: [AnyHashable: String] = [:]
	var lineNeedTotal: Int = 70
	var appearIndexTitle: String = "file"
	var justDictionary: [AnyHashable: String] = [:]

    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.pathModel()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.colorTo()
    ...
    var dropMenuStyle: SourceMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kCellData.map{styleLoad(name: $0)}, encoding: .utf8)!)
    }
    ...
    private func pathModel() -> UIImageView {
    ...
    private func sumSumimate() {
        //: let lineLayer = CAShapeLayer()
        let lineLayer = CAShapeLayer()
        //: lineLayer.strokeColor = UIColor.RGBA(230, 230, 230, 1.0).cgColor
        lineLayer.strokeColor = UIColor.viewSearch(230, 230, 230, 1.0).cgColor
