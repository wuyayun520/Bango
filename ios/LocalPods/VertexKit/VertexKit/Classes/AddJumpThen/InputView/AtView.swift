...
open class AtView: UITextView {
	var levelEnable: Bool = false
	var observerQuantity: Double = 29.0
	var blockDictionary: [AnyHashable: String] = [:]
	var playSoDoing: Bool = true
	var collectionTimeSum: Double = 83.7
	var giftDictionary: [AnyHashable: String] = [:]
	var colorEnable: Bool = false
	var tableTotal: Double = 22.7
	var faceDictionary: [AnyHashable: String] = [:]
    ...
    @IBInspectable open var placeholderColor: UIColor = AtView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
