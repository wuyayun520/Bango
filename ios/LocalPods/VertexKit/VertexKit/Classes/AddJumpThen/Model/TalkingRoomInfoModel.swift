...
/*: "id" :*/
fileprivate let k_partyBackgroundTitle:[Character] = ["i","d"]
...
struct TalkingGiftTitleTheoryModelType: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct MediaMeasurable: HandyJSON {
