...
fileprivate let k_imageNowMakeContent:[UInt8] = [0xc4,0xc3,0xc4,0xd9,0x85,0xce,0xc2,0xc9,0xc8,0xdf,0x97,0x84,0x8d,0xc5,0xcc,0xde,0x8d,0xc3,0xc2,0xd9,0x8d,0xcf,0xc8,0xc8,0xc3,0x8d,0xc4,0xc0,0xdd,0xc1,0xc8,0xc0,0xc8,0xc3,0xd9,0xc8,0xc9]

/*: "icon_livetc_warn" :*/
fileprivate let kInfoValue:[Character] = ["i","c","o","n","_","l","i","v","e","t"]
fileprivate let kPathData:String = "c_warnno name absolute leading"

/*: "OK" :*/
fileprivate let kHideValueTitle:String = "make"
...
class DelayThen: UIView {
    ...
    override init(frame: CGRect) {
        ...
        subSetupConstraintRecord()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: k_imageNowMakeContent.map{$0^173}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.collectionName(name: "icon_livetc_warn")
        iamg.image = UIImage.collectionName(name: (String(kInfoValue) + String(kPathData.prefix(6))))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = RowReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        lab.text = RowReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(grant), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension DelayThen {
    ...
    private func outsideDeleteVoice() {
    ...
    private func subSetupConstraintRecord() {
