...
fileprivate let k_imageValue:[UInt8] = [0x79,0x7e,0x79,0x84,0x38,0x73,0x7f,0x74,0x75,0x82,0x4a,0x39,0x30,0x78,0x71,0x83,0x30,0x7e,0x7f,0x84,0x30,0x72,0x75,0x75,0x7e,0x30,0x79,0x7d,0x80,0x7c,0x75,0x7d,0x75,0x7e,0x84,0x75,0x74]

fileprivate func superElse(last num: UInt8) -> UInt8 {
...
class ServiceItemLabel: UIView {
	var cutOpen: Bool = true
	var willTotal: Double = -97.2
	var iconButtonArray: [AnyHashable] = []
	var markDictionary: [AnyHashable: String] = [:]
	var itemOn: Bool = true
	var frameCount: Double = 36.5
	var quoteArray: [AnyHashable] = []
	var giftDictionary: [AnyHashable: String] = [:]

    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [TalkingGiftTitleTheoryModelType()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_imageValue.map{superElse(last: $0)}, encoding: .utf8)!)
    }
    ...
    func performance(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.appPath()
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.viewSearch(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.viewSearch(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension ServiceItemLabel {
    // 添加视图
    //: private func setupSubviews() {
    private func setupVoicePlay() {
