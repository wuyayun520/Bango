...
fileprivate let kReferValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class AddClickAnimationView: TalkingEventItemView {
	var playServiceClose: Bool = false
	var targetText: String = "communication"
	var reOff: Bool = true
	var listText: String = "number"
	var outsideOff: Bool = true
	var searchedText: String = "touch"
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kReferValue.reversed(), encoding: .utf8)!)
    }
    ...
    override func removeAnimating() {
        ...
        let filePath = SymbolReactiveCompatible.shared.stochasticProcessAbove(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.godspeed(effectItemView: self, success: true)
    ...
    override func colorationAnimation() -> Bool {
        //: return true
...
extension AddClickAnimationView: SVGAPlayerDelegate {
