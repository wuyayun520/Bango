...
fileprivate let kIndexName:[UInt8] = [0xe8,0xef,0xe8,0xf5,0xa9,0xe2,0xee,0xe5,0xe4,0xf3,0xbb,0xa8,0xa1,0xe9,0xe0,0xf2,0xa1,0xef,0xee,0xf5,0xa1,0xe3,0xe4,0xe4,0xef,0xa1,0xe8,0xec,0xf1,0xed,0xe4,0xec,0xe4,0xef,0xf5,0xe4,0xe5]

private func bottomKindBelow(button num: UInt8) -> UInt8 {
    return num ^ 129
}
...
class GiftMsgCell: VideoMsgCell {
	var underName: String = "container"
	var labArray: [AnyHashable] = []

    //: var giftData: SourceCellData?
    var giftData: SourceCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kIndexName.map{bottomKindBelow(button: $0)}, encoding: .utf8)!)
    }
...
extension GiftMsgCell {
    //: override func fill(with data: TCommonCellData) {
    override func fill(with data: TCommonCellData) {
        //: super.fill(with: data)
        super.fill(with: data)
        //: self.giftData = data as? SourceCellData
        self.giftData = data as? SourceCellData
