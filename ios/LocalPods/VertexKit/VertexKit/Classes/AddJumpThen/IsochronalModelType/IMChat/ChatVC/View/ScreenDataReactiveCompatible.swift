...
fileprivate let kSucceedName:[UInt8] = [0x7d,0x7a,0x7d,0x60,0x3c,0x77,0x7b,0x70,0x71,0x66,0x2e,0x3d,0x34,0x7c,0x75,0x67,0x34,0x7a,0x7b,0x60,0x34,0x76,0x71,0x71,0x7a,0x34,0x7d,0x79,0x64,0x78,0x71,0x79,0x71,0x7a,0x60,0x71,0x70]

private func imaginationImage(color num: UInt8) -> UInt8 {
    return num ^ 20
}
...
// __CLOSE_PRINT__
//
//  ScreenDataReactiveCompatible.swift
//  AbroadTalking
//
...
class ScreenDataReactiveCompatible: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func tableOfTexts(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return ScreenDataReactiveCompatible(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kSucceedName.map{imaginationImage(color: $0)}, encoding: .utf8)!)
    }
...
extension ScreenDataReactiveCompatible {
