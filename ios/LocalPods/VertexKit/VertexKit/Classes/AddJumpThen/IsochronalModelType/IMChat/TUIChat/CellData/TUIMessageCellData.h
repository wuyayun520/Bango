...
/// 消息翻译状态
typedef  NS_ENUM(NSUInteger, TMsgTranslateStatus) {
...
收益
 */
@property (nonatomic, assign) CGFloat msgIncome;
 ...
 *  MsgTranslate_succeed,    翻译成功
 */
@property (nonatomic, assign) TMsgTranslateStatus translateStatus;
 ...
 */
@property (nonatomic, strong) MessageCellLayout *cellLayout;


/**
 *  消息体内容
 */
@property (nonatomic, strong) PanAwakeModel *msgModel;
