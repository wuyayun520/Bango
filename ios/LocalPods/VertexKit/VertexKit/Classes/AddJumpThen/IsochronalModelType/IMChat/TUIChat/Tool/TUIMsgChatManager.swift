...
//
//        let userDic = ["uid":RowReactiveCompatible.share.loginUserMode.userID,"nickName":RowReactiveCompatible.share.loginUserMode.nickname,"headPic":RowReactiveCompatible.share.loginUserMode.headPic,"mbId":msgInfo["mbId"]]
...
//
//        if msgTypeStr == "gift" {
//            let cellData = AbSourceCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try PanAwakeModel.init(dictionary: tempDic)
...
//
//            let cellData = BeginCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try PanAwakeModel.init(dictionary: tempDic)
...
//            let cellData = ClickCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try PanAwakeModel.init(dictionary: tempDic)
...
//            let cellData = LengthReactiveCompatible.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try PanAwakeModel.init(dictionary: tempDic)
