...
fileprivate let k_viewContent:[UInt8] = [0x91,0x96,0x91,0x8c,0xd0,0x9b,0x97,0x9c,0x9d,0x8a,0xc2,0xd1,0xd8,0x90,0x99,0x8b,0xd8,0x96,0x97,0x8c,0xd8,0x9a,0x9d,0x9d,0x96,0xd8,0x91,0x95,0x88,0x94,0x9d,0x95,0x9d,0x96,0x8c,0x9d,0x9c]

private func sawdustSaloon(list num: UInt8) -> UInt8 {
    return num ^ 248
}
...
class RecordMiniView: DelayMiniView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_viewContent.map{sawdustSaloon(list: $0)}, encoding: .utf8)!)
    }
...
extension RecordMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func chemicalElement(liveUrl: String) {
...
extension RecordMiniView: TXLivePlayListener {
