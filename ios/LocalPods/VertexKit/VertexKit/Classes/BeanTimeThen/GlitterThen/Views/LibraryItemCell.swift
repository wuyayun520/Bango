...
fileprivate let k_modeFinishInName:[UInt8] = [0x85,0x82,0x85,0x98,0xc4,0x8f,0x83,0x88,0x89,0x9e,0xd6,0xc5,0xcc,0x84,0x8d,0x9f,0xcc,0x82,0x83,0x98,0xcc,0x8e,0x89,0x89,0x82,0xcc,0x85,0x81,0x9c,0x80,0x89,0x81,0x89,0x82,0x98,0x89,0x88]

/*: "icon_lounge" :*/
fileprivate let k_emptyValue:String = "icon_request array"
fileprivate let kHiddenValue:[Character] = ["l","o","u","n","g","e"]

/*: "#777777" :*/
fileprivate let kCountValue:[Character] = ["#","7","7","7","7","7","7"]

/*: "UID: :*/
fileprivate let k_positionMakeText:String = "UID:left false leading user"
...
class LibraryItemCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_modeFinishInName.map{$0^236}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.collectionName(name: (String(k_emptyValue.prefix(5)) + String(kHiddenValue)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(kCountValue)))
        //: return lab
        return lab
        //: }()
    }()
...
extension LibraryItemCell {
    ...
    func refreshBy(model: EventModelType) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.followOut(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .coloured() : .dropMultiView()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(k_positionMakeText.prefix(4))) + "\(model.uid)"
