...
class PlayReactiveCompatible: NSObject {
...
extension PlayReactiveCompatible {
    /// 释放资源
    ...
    func agePullOutAllTheStops(_ frontCamera: Bool) {
        ...
        self.dataMakeEqual(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func iconPath(_ openCamera: Bool) {
        ...
        self.underEventVideo(isOpen: openCamera)
    }
    ...
    func nascency() {
        ...
        DispatchQueue.main.async {
            ...
            self.same(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension PlayReactiveCompatible {
    ...
    private func dataMakeEqual(front: Bool) {
    ...
    private func underEventVideo(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_homeContent == true else {
            //: if isOpen {
            if isOpen {
...
extension PlayReactiveCompatible {
    ...
    func beyondStop() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(penetrate(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(modelBuild(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(backgroundNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(serverNotif(notif:)),
    ...
    @objc private func penetrate(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func modelBuild(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func backgroundNotif(notif: Notification) {
    ...
    @objc func serverNotif(notif: Notification) {
