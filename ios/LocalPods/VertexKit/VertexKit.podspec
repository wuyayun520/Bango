...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  #s.public_header_files = 'VertexKit/Classes/**/{VertexKit,NSString+AES128,BaseJsonModel,RBDMuteSwitch,AbTalkingAuditGiftBroadcastView}.h', 'VertexKit/Classes/BaseFile/**/*.h', 'VertexKit/Classes/MessageModule/IMSDKModule/IMChat/**/*.h'
  s.source_files = 'VertexKit/Classes/**/*'
  s.resources = "VertexKit/Resources/*.bundle"
  s.vendored_libraries = 'VertexKit/Classes/**/*.a'
