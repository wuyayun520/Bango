...
class _SubscriptionsPageState extends State<SubscriptionsPage> {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'BangoWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'BangoMonthVIP') {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                const Icon(Icons.emoji_events, color: Color(0xFF6A4C00), size: 28),
                      ...
                      const Text(
                        'Unlock your advanced privileges',
                        style: TextStyle(
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.emoji_events, color: Color(0xFF6A4C00), size: 44),
                      ),
                      const SizedBox(height: 8),
                      // Subscription cards
                      Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        plan.desc,
                                        style: TextStyle(
                                          color: selected ? const Color(0xFFFFE082) : const Color(0xFF4F46E5),
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15,
                                        ),
                                      ),
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () => _launchURL('https://sites.google.com/view/privacybango/home'),
                            style: TextButton.styleFrom(
