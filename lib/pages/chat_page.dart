      ...
      return Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: msg.isMe ? const Color(0xFFD9FF60) : Colors.white.withOpacity(0.9),
            borderRadius: BorderRadius.circular(16),
          ),
          child: Column(
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 36,
                      decoration: BoxDecoration(
                        color: msg.isMe ? Colors.black.withOpacity(0.2) : const Color(0xFFD9FF60).withOpacity(0.2),
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                        _isPlaying ? Icons.pause : Icons.play_arrow,
                        color: msg.isMe ? Colors.black : const Color(0xFFD9FF60),
                        size: 20,
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: (msg.isMe ? Colors.black : const Color(0xFFD9FF60)).withOpacity(0.3),
              ),
                child: LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation<Color>(
                              msg.isMe ? Colors.black : const Color(0xFFD9FF60)
                            ),
                            minHeight: 3,
                ),
              ),
          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  decoration: BoxDecoration(
                    color: isRecording ? Colors.red : const Color(0xFFD9FF60),
                    shape: BoxShape.circle,
                  ),
                  child: IconButton(
                    icon: Icon(
